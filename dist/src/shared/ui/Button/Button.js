...
export var Button = memo(function (props) {
    var _a;
    var className = props.className, children = props.children, _b = props.theme, theme = _b === void 0 ? ButtonTheme.OUTLINE : _b, square = props.square, disabled = props.disabled, _c = props.size, size = _c === void 0 ? ButtonSize.M : _c, fullWidth = props.fullWidth, otherProps = __rest(props, ["className", "children", "theme", "square", "disabled", "size", "fullWidth"]);
    var mods = (_a = {},
        _a[cls[theme]] = true,
