...
export var DrawerContent = memo(function (props) {
    ...
    var className = props.className, children = props.children, onClose = props.onClose, isOpen = props.isOpen;
...
export var Drawer = function (props) {
    return (_jsx(AnimationProvider, { children: _jsx(DrawerAsync, __assign({}, props)) }));
};
