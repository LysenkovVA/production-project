...
var ArticleRating = memo(function (props) {
    ...
    if (isLoading) {
        return _jsx(Skeleton, { width: "100%", height: 120 });
    }
    var rating = data === null || data === void 0 ? void 0 : data[0];
    return (_jsx(RatingCard, { onCancel: onCancel, onAccept: onAccept, rate: rating === null || rating === void 0 ? void 0 : rating.rate, className: className, title: t("Оцените статью"), feedbackTitle: t("Оставьте свой отзыв о статье"), hasFeedback: true }));
});
