...
module.exports = {
    ...
    "rules": {
        ...
        "i18next/no-literal-string": ["error", {
            markupOnly: true,
            ignoreAttribute: ["data-testid", "to", "name", "target", "justify", "align", "direction", "gap", "role", "as", "defaultValue", "border"]
        }],
        ...
        "raudbrand-plugin/layer-imports": ["error", {
            alias: "@",
            ignoreImportPatterns: ["**/StoreProvider", "**/testing"]
        }],
        "raudbrand-plugin/public-api-imports": ["error", {
            alias: "@",
